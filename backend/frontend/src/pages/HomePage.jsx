            ...
            (showFinished || !item.isCompleted) && (
              ...
              >
                <input
                  ...
                  className="checkbox"
                />
                <div id="list" className={item.isCompleted ? "line-through" : ""}>
                  {item.todo}
                </div>
                <div className="buttons">
                  <button onClick={(e) => handleEdit(e, item.id)} className="-add">
                    <MdEdit />
                  </button>
                  <button onClick={(e) => handleDelete(e, item.id)} className="-add">
                    <MdDelete />
                  </button>
                </div>
              </div>
